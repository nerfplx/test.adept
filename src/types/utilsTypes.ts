...
export type GetAvailableToolsRT = (tablePartsType:tableParts) => ReturnType<GetAvailableToolsType>;

export type SeparateCompaniesToTableArraysType = (companies:CompaniesType, selectedCompanies:Array<number>) => {
...
export type GenerateDataType = (companiesQty:number, workersQty:number) => CompaniesType;
