...
export type AddNewWorkerAction = PayloadAction<{
    companyId: number;
    worker: IWorker;
}>;
export type DeleteCompanyAction = PayloadAction<number[]>;
export type DeleteWorkerAction = PayloadAction<{
    workerId: number[];
    companyId: number;
}>;
...
export type AddNewRowRT = (
    tablePartsType: tableParts,
) => ReturnType<AddNewRowType>;
...
export type DeleteRowRT = (
    tablePartsType: tableParts,
) => ReturnType<DeleteRowType>;
...
export type EditRowRT = (updatedFields: {
    [key: string]: string | number;
}) => ReturnType<EditRowType>;
